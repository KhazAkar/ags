...
export default function ManageSliderComponents({children, roleFunction=undefined, objArray=undefined, closeCreatorFun=undefined, closeEditFun=undefined, index=undefined, role=undefined}) //role can be 'edit' 'add'
{
    ...
    let addHours = useRef(0);
    let addMins = useRef(0);
            ...
            <div className='inputContainer'>
                <div className='inputSliderData'>
                    <div class="form__group field">
                        <input type="input" class="form__field" placeholder="Slider name" id='SliderName' ref={label} />
                        <label for="SliderName" class="form__label">Slider name</label>
                    </div>
                {
                    role === 'add' ?
                    <>
                            <div class="form__group field">
                                <input type="input" class="form__field" placeholder="Slider name" id='Hours' ref={hours} name='HH'/>
                                <label for="Hours" class="form__label">Hours</label>
                            </div>

                            <div class="form__group field">
                                <input type="input" class="form__field" placeholder="Slider name" id='Minutes' ref={minutes} name='MM' />
                                <label for="Minutes" class="form__label">Minutes</label>
                            </div>

                            <div class="form__group field">
                                <input type="input" class="form__field" placeholder="Slider name" id='Seconds' ref={seconds} name='SS' />
                                <label for="Seconds" class="form__label">Seconds</label>
                            </div>
                    </>
                    :
                    <>
                            <div class="form__group field">
                                <input defaultValue={oldTime.oldHours} type="input" class="form__field" placeholder="Slider name" id='Hours' ref={hours} name='HH'/>
                                <label for="Hours" class="form__label">Hours</label>
                            </div>

                            <div class="form__group field">
                                <input defaultValue={oldTime.oldMinutes} type="input" class="form__field" placeholder="Slider name" id='Minutes' ref={minutes} name='MM' />
                                <label for="Minutes" class="form__label">Minutes</label>
                            </div>

                            <div class="form__group field">
                                <input defaultValue={oldTime.oldSeconds} type="input" class="form__field" placeholder="Slider name" id='Seconds' ref={seconds} name='SS' />
                                <label for="Seconds" class="form__label">Seconds</label>
                            </div>
