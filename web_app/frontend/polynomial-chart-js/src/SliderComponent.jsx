...
export default function SliderComponent({ children, minY, maxY, startTime, endTime, chartLabel, entryAddress }) 
{
    ...
    let sliderArray = useRef([{time: startTime, val: minY, label:'00:00:00'},{time: endTime, val: minY, label:'23:59:59'}])
